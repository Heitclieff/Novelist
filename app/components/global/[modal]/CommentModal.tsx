import React, { useMemo, useRef, useState, useCallback, useContext , useEffect} from 'react'
import { Center, Button,Box,Text, Modal, FormControl, Input , Divider, VStack, HStack } from 'native-base';
